...
import CarRentalSearchForm from '../../components/HeroInputSearch/CarRentalSearchForm';
  ...
  return (
    <div>
      {/* <Loader data={ 
        ...
        // staticpagetext[0].translations.car_rental &&
        // staticpagetext[0].translations.car_rental_description &&
        transports.length > 0 && 
        exclusiveoffers.length > 0 && 
        PopularData.length > 0 && PopularHotelsDealsData.length > 0 ? false : true }/>
      */}
      <Helmet>
        <meta charSet="utf-8" />
        <title> Bookperfect || Car Rental </title>
      </Helmet>

      <HeroHead
        className='hero-head-search-rentacar'
        searchCard='rentacar'
        headText={ (staticpagetext && staticpagetext[0].translations.car_rental) ?? "Car Rental" }
        subText={(staticpagetext && staticpagetext[0].translations.car_rental_description) }
        characteristicsInnerWrapperClassNames={'!pt-8'}
     />
      ...
      {/* information */}
      {/* <div>
        <BestBrands statictext = { staticpagetext && staticpagetext[0].translations }  />
      </div> */}
...
export default SearchCarRental;